...
// Becca: Initial call for data from
async function getRestaurants(restData) {
  ...
  for(var i = 0; i < restData.length; i++){
    ...
    /* BECCA: Will not need this since will be working with dummy data
    Instead, will just assume we already have */
    ...
    /* BECCA: End image request functionality */
    ...
    /* BECCA: Output of above is typesArray,
    eg [ "Bar", "Restaurant", "Food", "Point Of Interest", "Establishment" ]
    ...
    /* BECCA: Above creates a sorted array of nearby restaurants,
    eg [ "ChIJDVaCXjd-j4AR4AOGUS0kLGc", "ChIJr-EMFjd-j4ARHKaF3ehlmgY", "ChIJH3SFojx-j4AR-ceZkVNV7PA", "ChIJ10DmyyR-j4ARBZDBrVVevpo", "ChIJmZN_ljx-j4ARF16HqVQ2vnI", "ChIJ0WvRSyN-j4ARpvLPuZyI3l4" ] */
    ...
    var restaurant = {
      ...
      photos: photosURLArray, // Created by request
      ...
      types: typesArray, // Created by parsing above
      nearby: distArr // Created by calculation and parsing above
    }
...
/* BECCA: Fn below used to create typesArray */
...
/* BECCA: Fn below used to calculate distance to generate distArr */
